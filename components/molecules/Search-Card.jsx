...
export default function SearchCard({img, location, type, id, code, price}) {
    ...
    return (
        <article onClick={() => router.push(`/buscar-propiedad/${slug}`)}
                 className="md:w-11/12 w-full rounded-md shadow-md bg-white p-2 my-3 transform transition motion-reduce:transform-none hover:scale-105 hover:shadow-xl duration-500">

 ...
 */
export default function SearchCard({img, title, subtitle, id, code, description}) {
    ...
    return (
        <article onClick={() => router.push(`/buscar-propiedad/${slug}`)}
            ...
            <div className="flex my-5">
                <div>
                    <img src="https://i.ibb.co/0D03wrT/img2.jpg" alt="PENDIENTE SEO" className="max-h-20 max-w-20"></img>
                </div>

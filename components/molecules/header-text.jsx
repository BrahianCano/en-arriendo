        ...
        <section className="my-10 font-axiformaHeavy">
            ...
            */}
            ...
            <div className="text-gray-600">
                <input type="search" name="serch" placeholder="Buscar En Arriendo"
                       className="bg-white h-10 px-5 pr-10 rounded-full text-sm focus:outline-none border-1 border-solid border-inputColor mt-16 block mr-auto ml-auto min-w-400"></input>
            </div>
        </section>
    );
}
